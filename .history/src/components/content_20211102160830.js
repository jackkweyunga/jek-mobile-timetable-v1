                        ...
                        for (let period of data.events) {
                            if ((period.day.slice(0, 3) === days[i]) && (period.type == type)) {
                                ...
                                if (k + 8 === start || k + 8 === end) {
                                    ...
                                    checkForCollision(`${period.group}-${period.type}`, tRange(start, end), days[i]);
                                    ...
                                    lb.innerHTML = `
                                        ...
                                        ">
                                        <span style="font-size: 0.5rem;">${period.group} ${period.type} <br> ${period.room} <br>${start} - ${end} </span>
                                        </div>
                                        `;
                                    lb.style = `
                                        position: absolute;
