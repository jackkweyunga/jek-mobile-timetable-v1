...
(function () {
   ...
   * filter
   */
  var programmes = axios('http:127.0.0.1:8000/api/v1/programme_namelist/');

  var ul = document.getElementById("programme-list");
  ...
  var render_lists = function (lists) {
    ...
    for (let index of lists) {
      ...
      <li class='list-group-item list-group-item-action'>
        <h2 style="color:#225DCC;" class="programme-header"> ${index} </h2>
        <small style="font-weight: 100;" class="badge bg-secondary">First year</small>
      </li>`;
    }
    ul.innerHTML = li;
  }
