    ...
    for (let el of lists) {
      ...
      <li class='list-group-item'>
        ...
        for (let t of el["tags"]) {
          li += `<button onclick="window.localStorage.setItem('selected-programme', '${JSON.stringify(el)}');" style="font-weight: 100;" class="m-1 shadow-sm text-link btn btn-sm bg-white"> ${t} </button>`
        }
